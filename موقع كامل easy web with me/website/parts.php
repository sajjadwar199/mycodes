...
mysqli_select_db($connect,'cpanal');
	...
	*/
	$query = "SELECT COUNT(*) as num FROM $tbl_name where part='$parts' limit 2";
	$total_pages = mysqli_fetch_array(mysqli_query($connect,$query));
	@$total_pages = $total_pages[num];
	
	/* Setup vars for query. */
	$targetpage = "parts.php"; 	//your file name  (the name of this file)
	...
	/* Get data. */
	$sql = "SELECT * FROM $tbl_name where part='$parts' LIMIT $start, $limit";
